...
import pe.egcc.comprobante.util.MyMath;
...
public class CompView extends javax.swing.JFrame {
  ...
  private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
    try {
      ...
      if(sTotal.isEmpty()){
        throw new Exception("No se ha ingresado el total.");
      }
      if(!MyMath.isDouble(sTotal)){
        throw new Exception("El total debe ser numérico.");
      }
